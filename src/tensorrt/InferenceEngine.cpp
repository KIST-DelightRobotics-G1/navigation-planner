...
#include "tensorrt/Log.h"

// picosha2 tickles a false-positive -Wstringop-overflow on gcc 13.
...
)
{
    ...
    // Create network (explicit batch is default in TRT 10+; no flag needed)
    ...
    // Set the precision level (platformHasFastFp16() removed in TRT 10;
    // all supported GPUs have fast FP16 in practice).
